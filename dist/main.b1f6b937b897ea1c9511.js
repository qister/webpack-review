...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "." + "b1f6b937b897ea1c9511" + ".js"
/******/ 	}
/******/
...
__webpack_require__.e(/*! import() */ 0).then(__webpack_require__.t.bind(null, /*! lodash */ "../node_modules/lodash/lodash.js", 7)).then(function (_) {
  console.log('Lodash', _.random(0, 21, false));
});
...
var post = new _models_Post_js__WEBPACK_IMPORTED_MODULE_1__["default"]('Webpack post title', _assets_webpack_logo_png__WEBPACK_IMPORTED_MODULE_3__["default"]); // $('pre').addClass('code').html(post.toString())
